export default function PrivacidadPage() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-16 text-zinc-100">
      ...
      <p className="mb-8 text-sm text-zinc-500">Lausana — Última actualización: {new Date().toLocaleDateString('es-MX')}</p>
      ...
      <div className="flex flex-col gap-6 text-sm leading-relaxed text-zinc-300">
        ...
        <section>
          ...
          <p>Para preguntas sobre esta política, contáctanos a través de nuestros canales oficiales de Lausana.</p>
        </section>
      </div>
    </div>
  );
